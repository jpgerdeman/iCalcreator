...
{	
	...
	public function testGetComponentByUid()
	{
		...
		// Checks wether the next element (first) has given uid
		$this->assertFalse( $holder->getComponent($id), "UID of 3rd component matches that of 1st" );
		// Checks wether the 3rd element has given uid
		$this->assertEquals( $component, $holder->getComponent($id, 3));
	}
