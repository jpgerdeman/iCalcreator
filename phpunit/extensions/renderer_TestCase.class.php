...
class renderer_TestCase extends iCalCreator_TestCase
{
	...
	{		
		...
		$this->assertContains($expected,$this->getRenderer()->createVersion());
	}
	...
	{		 
		...
		$scale = $this->getRenderer()->createCalscale();
	...
	{		
		...
		$this->assertContains($expected,$this->getRenderer()->createMethod());
	}
}