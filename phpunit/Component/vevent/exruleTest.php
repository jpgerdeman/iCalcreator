...
class exruleTest extends calendarComponent_TestCase
{
	...
	public function exruleProvider()
	{
		...
		return array(
			...
			array( $detailed, 'EXRULE:FREQ=MONTHLY;UNTIL=20070203T000000Z;INTERVAL=2;BYSECOND=2;BYMINUTE=2 ,-4,6;BYHOUR=2,4,-6;BYDAY=-2WE,3TH,5FR,SA,SU;BYMONTHDAY=-2;BYYEARDAY=2;BYW EEKNO=2,-4,6;BYMONTH=2;BYSETPOS=2,-4,6;WKST=SU' ),
			...
			array( array( 'FREQ' => "MONTHLY", 'UNTIL' => array( 'timestamp' => 1354291267 ), 'BYday' => array( -1, 'DAY' => 'MO' )) , 'EXRULE:FREQ=MONTHLY;UNTIL=20121130T170107Z;BYDAY=-1MO'),
		);
	}
}